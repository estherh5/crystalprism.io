...
var pastel = ['#ffe4e7', '#ffc5a7', '#fff0a5', '#ffffa9', '#d2ffc5', '#cffeff'];
var seashore = ['#594f4f', '#547980', '#45ada8', '#9de0ad', '#e5fcc2', '#f9ebc2'];
var bold = ['#00a0b0', '#6a4a3c', '#cc333f', '#eb6841', '#edc951', '#a1ad1a'];
var oblique = ['#ca8484', '#ff3d7f', '#ff9e9d', '#8484ca', '#3fb8af', '#7fc7af'];
var contrast = ['#e3d1ff', '#cbe86b', '#f2e9e1', '#1c140d', '#f9abab', '#95d8e5'];
var calico = ['#f5f5c7', '#dce9be', '#555152', '#2e2633', '#99173c', '#46c2dd'];
var mauve = ['#413e4a', '#73626e', '#b38184', '#f0b49e', '#f7e4be', '#bce4bf'];
var grayscale = ['#ffffff', '#999999', '#666666', '#333333', '#111111', '#000000'];
...
function postDrawing() {
  ...
  if (drawingCanvas.toDataURL() == 'data:image/png;base64,') {
